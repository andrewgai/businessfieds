...
$cryptheight = 25;   // Hauteur du cryptogramme (en pixels)
...
$charR = 255;     // Couleur des caract�res au format RGB: Red (0->255)
$charG = 255;     // Couleur des caract�res au format RGB: Green (0->255)
$charB = 255;     // Couleur des caract�res au format RGB: Blue (0->255)
...
$charsizemax = 12;      // Taille maximum des caract�res
